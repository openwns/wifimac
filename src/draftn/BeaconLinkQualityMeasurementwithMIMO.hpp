...
namespace wifimac { namespace draftn {
    ...
    public:
	    ...
	    SINRwithMIMOInformationBase::AddressToFactorsMap rxMIMOfactors;
        } peer;
    ...
    public:
        /** @brief Creator*/
        BroadcastLinkQualitywithMIMO(const wns::pyconfig::View& config_,
	...
	getMIMOfactors();
        ...
        newPeerMeasurement(double peerSuccessRate, wns::Ratio peerSINR, SINRwithMIMOInformationBase::NumSSToFactorMap factors);
	...
	double getBestTotalRate(wns::Ratio peerSINR, SINRwithMIMOInformationBase::NumSSToFactorMap factors);
        ...
        BeaconLinkQualityMeasurementwithMIMO* parent;
	 ...
	 */
    class BeaconLinkQualityMeasurementwithMIMO :
        public wns::ldk::fu::Plain<BeaconLinkQualityMeasurementwithMIMO, BeaconLinkQualityMeasurementwithMIMOCommand>,
    ...
    public:
        ...
        /** @brief Destructor */
        virtual 
        ~BeaconLinkQualityMeasurementwithMIMO();
    ...
    private:
        ...
        /** @brief Map of address to BroadcastLinkQualitywithMIMO */
        typedef wns::container::Registry<wns::service::dll::UnicastAddress, BroadcastLinkQualitywithMIMO*> adr2qualityMap;
